...
<div class="topic-item">
    ...
    <nuxt-link :to="url" v-slot="{ href, route, navigate, isActive, isExactActive }">
      <a :class="['topic-item__link']" :href="href" @click="navigate">{{ title }}</a>
    </nuxt-link>

    <div class="topic-item__meta">
      
      <div v-if="author" class="topic-item__author">
        <img decoding="async" width="20px" height="20px" class="topic-item__author-pic" :src="avatar" :alt="author.full_name" loading="lazy">
