...
>
  ...
  <div :class="['soft-item__wrap', hover && 'soft-item__wrap_hover']">
    <div class="soft-item__top">
      <div v-if="discount && discount_value && available" class="soft-item-discount">
      ...
      <div class="soft-item__title-wrap">
        ...
        <span :class="['soft-item__title', hover && 'soft-item__title_hover']">{{ title }}</span>
      </div>
      <div :class="['soft-item__img-wrap']">
        <img :class="['soft-item__img']" decoding="async" loading="lazy" :src="img" :alt="image.alt || `${title} logo`">
      </div>
    </div>

    <div :class="['soft-item__info', hover && 'soft-item__info_hover']" v-html="short_description"></div>
    ...
    <div class="soft-item__actions">
      <soft-action-button
        ...
        type="download"
      />
      <nuxt-link v-if="review" :to="{name: 'index', params: {parent: review.page.parent.slug, child: review.page.slug}}" v-slot="{ href, route, navigate }">
          <a :class="[
            'btn',
            'soft-item__link',
          ...
          ]" :href="href" @click="navigate">Детали</a>
      </nuxt-link>
