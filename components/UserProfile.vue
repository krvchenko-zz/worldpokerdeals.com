...
<div class="user-profile">
  <div class="user-profile-header">
    ...
    <div class="user-profile__avatar">
      <img
        ...
        :alt="user.full_name"
      />
      <svg-icon v-else class="user-profile__icon" :width="68" :height="68" viewBox="0 0 36 36" icon="user-avatar"/>
    </div>
  </div>
  <div class="user-profile-body">
    ...
    <div v-if="user.birthday" class="user-profile-row">
      ...
      <span class="user-profile-row__sep"></span>
      <span class="user-profile-row__val">{{ dateFormat(user.birthday) }}</span>
    </div>
