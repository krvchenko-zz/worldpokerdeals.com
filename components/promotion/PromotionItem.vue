<template>
	<article :class="['promotion-item', featured && 'promotion-item_featured']">
		...
		>
			<a
				:class="[
					'promotion-item__img-link',
					featured && 'promotion-item__img-link_featured',
				]"
				:href="href"
				@click="navigate"
			>
		...
		<div
			:class="[
				...
				featured && 'promotion-item__inner_featured',
			]"
		>
			<div
				:class="[
					'promotion-item__prize',
			...
			<div v-if="!featured" :class="['promotion-item__meta']">
				...
				<span
					class="promotion-item__category"
					:style="{ color: category.label_color }"
					>{{ category.title }}</span
				>
			...
			>
				<a
					:class="[
						...
						featured && 'promotion-item__link_featured',
					]"
					:href="href"
					@click="navigate"
					>{{ title }}</a
			...
			<div
				:class="[
					...
					featured && 'promotion-item__info_featured',
				]"
			>
				<div v-if="!featured" class="promotion-item__author">
					<img
						...
						width="24px"
						height="24px"
						class="promotion-item__author-pic"
						:src="avatar"
						:alt="author.full_name"
						loading="lazy"
					/>
					<span class="promotion-item__author-name">{{
						author.full_name
					}}</span>
				</div>

				<countdown v-if="time_left" label="До конца" :days="time_left.days" />
				<countdown
					v-if="time_before"
					label="До начала"
				...
				<countdown v-if="regularity" :label="regularity" />
			</div>
		</div>
	</article>
</template>
