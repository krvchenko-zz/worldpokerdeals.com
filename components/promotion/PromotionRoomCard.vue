...
<div :class="['promotion-room']">
  <div class="promotion-room__img" :style="{
  ...
  <div class="promotion-room__wrap">
    ...
    <div class="promotion-room__actions">
      <nuxt-link :to="{
        ...
        <a :class="['btn', 'btn-block', 'promotion-room__link promotion-room__link_review']" :href="href" @click="navigate">Обзор</a>
      </nuxt-link>

      <nuxt-link v-if="review" :to="`/rakeback-deals/${review.url}/play`" v-slot="{ href, route, navigate }">
          <a :class="['btn', 'btn-block', 'promotion-room__link', 'promotion-room__link_download']" :href="href" @click="navigate">Учавствовать</a>
      </nuxt-link>
    </div>
