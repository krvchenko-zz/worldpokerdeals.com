	...
	<div class="review-form">
		...
		>
			<div class="review-form__rate-wrap inline">
				<label class="review-form__label review-form__label_rate"
					>Общая оценка</label
				>
				<div class="review-form__rate">
					...
					<span class="review-form__reset" @click="form.rate = 0"
						>Сбросить</span
					>
				</div>
			</div>
			...
			<div class="review-form__textarea-wrap inline">
				<label class="review-form__label review-form__label_pros"
					>Достоинства</label
				>
				<div class="review-form__pros">
					<textarea
						...
						:class="[
							...
							form.errors.has('pros') && 'has-error',
						]"
						name="pros"
					></textarea>
			...
			<div class="review-form__textarea-wrap inline">
				<label class="review-form__label review-form__label_cons"
					>Недостатки</label
				>
				<div class="review-form__cons">
					<textarea
						...
						:class="[
							'review-form__textarea',
							form.errors.has('cons') && 'has-error',
						]"
						name="cons"
					></textarea>
					<transition name="fade">
