...
<tbody class="bonus-item">
  <tr class="bonus-item__row">
    <td class="bonus-item__col bonus-item__col_icon">
      <svg-icon v-if="room" class="bonus-item__icon" :icon="room.slug" :width="42" :height="42" viewBox="0 0 200 200" />
    </td>
    ...
    <td class="bonus-item__col bonus-item__col_max">
      <span class="bonus-item__max">{{ max_bonus_currency.symbol }}{{ max_bonus }}</span>
    </td>
    ...
    <td class="bonus-item__col bonus-item__col_bonus">
      ...
      >
        <span
          :class="['bonus-item__code-label', codeHovered && 'bonus-item__code-label_hover']"
        >Бонус-код</span>
    ...
    <td class="bonus-item__col bonus-item__col_action">
        <nuxt-link prefetch :to="{name: 'index', params: {
          ...
          <a :class="['btn btn-bonus-review']" :href="href" @click="navigate"></a>
        </nuxt-link>
    </td>
  </tr>
  <tr class="bonus-item__row">
    <td colspan="8" :class="['bonus-item__col', 'bonus-item__col_info', showTerms && 'bonus-item__col_info_expanded']">

      <span :class="['bonus-item__terms', showTerms && 'bonus-item__terms_expanded']">
  ...
  <tr v-show="showTerms" class="bonus-item__row">
    <td colspan="8" class="bonus-item__col bonus-item__col_terms" v-html="terms"></td>
  </tr>
</tbody>
</template>
