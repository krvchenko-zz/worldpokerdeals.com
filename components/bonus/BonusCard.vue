...
<div :class="['bonus-card']">
  ...
  <div class="bonus-card__header">
    <svg-icon class="bonus-card__icon" :icon="slug" :width="76" :height="76" viewBox="0 0 200 200"/>
    <div class="bonus-card__info">
      ...
      <nuxt-link :to="{
        ...
        <a :class="['btn', 'bonus-card__link bonus-card__link_review']" :href="href" @click="navigate">Обзор рума</a>
      </nuxt-link>
    </div>
  </div>
  ...
  <div class="bonus-card__footer">
    <div v-if="bonus" class="bonus-card-bonus">
      <svg-icon class="bonus-card-bonus__icon" icon="room-top-bonus" :width="24" :height="24" :opacity="1" :fill="bonus_category_label" viewBox="-6 -6 24 24"/>
      <div :style="{background: bonus_category_label}" class="bonus-card-bonus__category">{{ bonus_category }}</div>
