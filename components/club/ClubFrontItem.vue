...
<div :class="['club-front-item', toggled && 'club-front-item_toggled']">
  <div :class="['club-front-item__header']">
    <div class="club-front-item__room">
      <svg-icon class="club-front-item__room-icon" viewBox="0 0 200 200" :icon="room.slug" :width="16" :height="16" />
      {{ room.title }}
    </div>
    ...
    <div :class="['club-front-item__logo']">
      <img :class="['club-front-item__img']" decoding="async" loading="lazy" :src="img" :alt="image.alt || `${title} logo`">
    </div>
  </div>

  <div :class="['club-front-item__wrap', toggled && 'club-front-item__wrap_toggled']">
    ...
    <div style="margin-bottom: 12px;" class="club-front-item__prop-wrap">
      ...
      <span @click="handleCopy" class="club-front-item__prop club-front-item__prop_id">{{ club_id }}</span>
    </div>
    ...
    <ul :class="['club-front-item__features', toggled && 'club-front-item__features_toggled']">
      <li v-for="(item, index) in features.filter((item, i) => { return i < 4})"
        :key="index"
      ...
      <li v-if="toggled" v-for="(item, index) in features.filter((item, i) => { return i >= 4})"
        :key="index"
        class="club-front-item__feature"
        :title="item.title"
      >
      ...
      <li v-if="features.length > 4" :class="['club-front-item__toggle', toggled && 'club-front-item__toggle_hide']"
  ...
  &__features {
    ...
    &_toggled {
      ...
      &:after {
        ...
        height: 36px;
        width: 100%;
        background: linear-gradient(180deg, rgba(250, 250, 250, 0) 0%, #E9E9E9 100%);
