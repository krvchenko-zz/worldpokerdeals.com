...
<div :class="['room-recomended']">
  <div class="room-recomended__img" :style="{
  ...
  <div class="room-recomended__wrap">
    ...
    <div class="room-recomended__actions">
      <nuxt-link :to="{
        ...
        <a :class="['btn', 'btn-block', 'room-recomended__link room-recomended__link_review']" :href="href" @click="navigate">Обзор</a>
      </nuxt-link>

      <nuxt-link v-if="review" :to="`/rakeback-deals/${slug}/play`" v-slot="{ href, route, navigate }">
        <a :class="['btn', 'btn-block', 'room-recomended__link', 'room-recomended__link_download']" :href="href" @click="navigate">Перейти</a>
      </nuxt-link>
    </div>
