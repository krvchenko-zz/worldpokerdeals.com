<template>
  <div class="filters">
    ...
    <filter-dropdown
      v-if="disciplines && disciplines.length"
      :opened="true"
      :label="$t('by_games')"
    ...
    <filter-dropdown
      v-if="certificates && certificates.length"
      :label="$t('rng_check')"
