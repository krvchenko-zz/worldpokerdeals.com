...
<div class="room-params">
	<div class="room-params__label room-params__label_support">Служба поддержки</div>
  <div class="room-params__list">
    ...
    <div class="room-param room-param_languages">
      ...
      <div class="room-param__value room-param__value_languages">
        <svg-icon v-for="(item, index) in languages" :key="index" class="room-param__language" :icon="item.code.toUpperCase()" prefix="flags/" width="20" height="20" />
      </div>
    </div>
