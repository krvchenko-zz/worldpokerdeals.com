...
<div class="comment-form">
  <form class="comment-form__form" @submit.prevent="create" @keydown="form.onKeydown($event)">
    <div class="comment-form__textarea-wrap">
      <textarea :class="['comment-form__textarea', form.errors.has('text') && 'has-error']" v-model="form.text" name="text"></textarea>
      <transition name="fade">
        <has-error :form="form" field="text" />
      </transition>
    </div>
    <div class="comment-form__submit">
      <button class="btn btn-primary" type="submit" :loading="loading">Комментировать</button>
    </div>
  </form>
</div>
</template>
