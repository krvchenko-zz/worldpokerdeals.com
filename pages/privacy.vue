          ...
          <ul class="terms-extra">
            ...
            >
              <li v-if="!isExactActive" class="terms-extra__item">
                <a class="terms-extra__link" :href="href" @click="navigate">Пользовательское соглашение</a>
              </li>
            </nuxt-link>
            <nuxt-link
              v-slot="{ href, isActive, isExactActive, navigate }"
            ...
            >
              <li v-if="!isExactActive" class="terms-extra__item">
                <a class="terms-extra__link" :href="href" @click="navigate">Политика приватности</a>
              </li>
            </nuxt-link>
            ...
            >
              <li v-if="!isExactActive" class="terms-extra__item">
                <a class="terms-extra__link" :href="href" @click="navigate">Политика куки-файлов</a>
              </li>
            </nuxt-link>
          </ul>
        </div>
