							...
							<div class="skrill-advantages">
								...
								<div class="skrill-advantages__row">
									...
									<div class="skrill-advantages__col">
										...
										/>
										<span class="skrill-advantages__label"
											><b>Поддержка на русском языке</b> по email, Skype,
											Telegram и в соцсетях</span
										>
									</div>
									<div class="skrill-advantages__col">
										<svg-icon
								...
								<div class="row">
									<div class="col-6">
										<div class="skrill-card">
											...
											<div class="skrill-card__info">
												Если вы еще не зарегистрировались в Skrill, то
												регистрируйтесь с нами и получайте эксклюзивные бонусы
											</div>
											<ul class="skrill-card__list">
												<li class="skrill-card__list-item">
													...
													<span class="skrill-card__item"
														><b>Две карты Skrill Prepaid MasterCard</b>
														бесплатно (для VIP Silver +)</span
													>
												</li>
												...
												<li class="skrill-card__list-item">
													...
													/>
													<span class="skrill-card__item"
														><b>0% комиссия</b> за переводы клиентов внутри
														системы и вывод на банковский счет</span
													>
												</li>
											...
											<div class="skrill-card__footer">
												<div class="skrill-card__details">
													<p>
														<span>* </span> Актуально только для пользователей
														из стран SEPA
													</p>
													<p>
														<span>** </span> Вывод на VISA 7,5% для всех
														статусов
													</p>
												</div>
												<payments-button-action
									...
									<div class="col-6">
										<div class="skrill-card">
											...
											<div class="skrill-card__info">
												Если у вас уже есть аккаунт в Skrill, то просто
												присоединяйтесь к нашей программе лояльности и получайте
												бонусы и условия, которые мы предоставляем
											</div>
											<ul class="skrill-card__list">
												<li class="skrill-card__list-item">
													<svg-icon
