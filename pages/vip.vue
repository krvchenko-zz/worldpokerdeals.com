      ...
      <div class="row">
        <div class="col-10 offset-md-1">
          <div class="vip-header">
            ...
            <div class="vip__description">Хочешь стать нашим игроком или партнёром? Начинай играть <br> в покер-румах с нами и получи доступ к нашим <b>VIP-услугам</b></div>
          ...
          <div class="vip-body">
            <div class="row">
              <div class="col-8">
                <div class="vip__list">
                  <div class="row">
                    <div class="col-6" v-for="(item, index) in services" :key="index">
                      <div class="vip-item">
          ...
          <div class="vip-footer">
            ...
            <div class="vip-features">
              <div class="vip-feature" v-for="(item, index) in features" :key="index">
    ...
    services: [
      {
        ...
        text: 'Таиланд, Бали, Турция. Рейкбек в Тайских Батах и помощь с визами',
        icon: 'vip-transfer'
      }
    ],
...
.content_vip {
  background: linear-gradient(0deg, #262937, #262937), radial-gradient(96.88% 66.11% at 57.43% 2.13%, #3A3E51 0%, #1D1F2C 100%);
...
.vip {
  ...
  &-item {
    ...
    margin-bottom: 32px;
    padding: 28px;
    background: radial-gradient(173.62% 345.07% at 75% -13.07%, #3A3E51 5.73%, #262937 100%);
